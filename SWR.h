...
#define                DATE    "2020-03-15"
#define                LastUpdate  "by CT1DHR"
...
//-----------------------------------------------------------------------------  
//
#define NEXTION_ENABLE   0  // 1 to enable, else 0.
#define NEXTION                   0// 1 enable
#define EASYNEXTION       1
//-----------------------------------------------------------------------------
// Enable Encoder and Pushbutton
#define PUSHBUTTON_ENABLED        0 // 1 to enable, else 0.  Harmless if not used
...
#define CAL1_NOR_VALUE_c1          400 // 40 dBm, default dBm level1 for both AD8307
#define CAL2_NOR_VALUE_c1          100 // 10 dBm, default dBm level2 for both AD8307
#define CALFWD1_c1                 2.452 // Default raw Voltage level1 at 40 dBm
#define CALREV1_c1                 2.452 // Default raw Voltage level1 at 40 dBm
#define CALFWD2_c1                 1.702 // Default raw Voltage level2 at 10 dBm
#define CALREV2_c1                 1.702 // Default raw Voltage level2 at 10 dBm

#define CAL1_NOR_VALUE_c2          400 // 40 dBm, default dBm level1 for both AD8307
#define CAL2_NOR_VALUE_c2          100 // 10 dBm, default dBm level2 for both AD8307
#define CALFWD1_c2                 2.452 // Default raw Voltage level1 at 40 dBm
#define CALREV1_c2                 2.452 // Default raw Voltage level1 at 40 dBm
#define CALFWD2_c2                 1.702 // Default raw Voltage level2 at 10 dBm
#define CALREV2_c2                 1.702 // Default raw Voltage level2 at 10 dBm

#define CAL1_NOR_VALUE_c3         400 // 40 dBm, default dBm level1 for both AD8307
#define CAL2_NOR_VALUE_c3          100 // 10 dBm, default dBm level2 for both AD8307
#define CALFWD1_c3                 2.452 // Default raw Voltage level1 at 40 dBm
#define CALREV1_c3                 2.452 // Default raw Voltage level1 at 40 dBm
#define CALFWD2_c3                 1.702 // Default raw Voltage level2 at 10 dBm
#define CALREV2_c3                 1.702 // Default raw Voltage level2 at 10 dBm

#define CAL1_NOR_VALUE_c4          400 // 40 dBm, default dBm level1 for both AD8307
#define CAL2_NOR_VALUE_c4          100 // 10 dBm, default dBm level2 for both AD8307
#define CALFWD1_c4                 2.452 // Default raw Voltage level1 at 40 dBm
#define CALREV1_c4                 2.452 // Default raw Voltage level1 at 40 dBm
#define CALFWD2_c4                 1.702 // Default raw Voltage level2 at 10 dBm
#define CALREV2_c4                 1.702 // Default raw Voltage level2 at 10 dBm
...
*/
const int EncI              =  27; // 27; //19;
const int EncQ              =  26; // 26; // 17;
const int EnactSW           =  14; // 14; //16;  // Menu/Enact Switch
...
typedef struct {
          cal_t    cal_AD[2]; 
          cal_t    cal_AD1[2];               // 2 Calibration points for both AD8307, if AD8307 option
          cal_t    cal_AD2[2];                // Coupler 2 with 2 Calibration points for both AD8307
          cal_t    cal_AD3[2];                // Coupler 3 with 2 Calibration points for both AD8307
          cal_t    cal_AD4[2];                // Coupler 4 with 2 Calibration points for both AD8307
...
#endif  // da macro #ifndef _PSWR_H_