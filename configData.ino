...
//***********************************************
  ...
  const String cplName1= doc["cpl_name1"];
  const String cplName2= doc["cpl_name2"];
  const String cplName3= doc["cpl_name3"];
  const String cplName4= doc["cpl_name4"];

   coupler_name[0]= cplName1;
   coupler_name[1]= cplName2;
   coupler_name[2]= cplName3;
   coupler_name[3]= cplName4;
...
//**************************************
  ...
  const String cplName1= coupler_name[0];
  const String cplName2= coupler_name[1];
  const String cplName3= coupler_name[2];
  const String cplName4= coupler_name[3];



   doc["ssid"]= ssid_from_display;
   doc["pass"]= password_from_display;
   doc["cpl"] =current_coupler;



   doc["cpl_name1"]= cplName1;
   doc["cpl_name2"]= cplName2;
   doc["cpl_name3"]= cplName3;
   doc["cpl_name4"]= cplName4;
